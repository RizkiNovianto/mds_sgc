                        ...
                        <div id="carousel-example" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="../images/logo_sgc.png" style="height: 150px;">
                                </div>
                                <div class="item">
                                    <img src="../images/Under Const 1.png" style="height: 150px;">
                                </div>
                                <div class="item">
                                    <img src="../images/In Progress.jpg" style="height: 150px;">
                                </div>
                            </div>
                            <!-- End Carousel Images -->
                            <!-- Carousel Controls -->
...
<!--                        <div class="col-md-4 text-center">
                        ...
                        <div class="col-md-4 text-center">
                            <img src="../images/header_sby_trans.png" style="height: 200px">
                        </div>
                        <div class="col-md-4 text-center">
                ...
                <div class="container background-white bottom-border">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>Website ini akan digunakan sebagai gateway pelaksanaan lomba kebersihan yang diselenggarakan di Kota Surabaya.</p>
                            <p>Website ini masih berada pada tahap pembangunan. Kami memohon pada anda untuk menantikan hasil akhir pengerjaan kami</p>
                        </div>
                        <!-- End Main Text -->
                        <div class="col-md-6">
                            
                            <h3 class="padding-vert-10" style="text-align: center; font-weight: bold">Sedang Diproses</h3>
                            <p style="text-align: center">
                                <img src="../images/Coming Soon.png"></br>
                               <?php /* Duis sit amet orci et lectus dictum auctor a nec enim. Donec suscipit fringilla elementum. Suspendisse nec justo ut felis ornare tincidunt vitae et lectus.</p>
                    ...
                    <div class="row padding-top-40">
                        <ul class="portfolio-group">
                            ...
                            <li class="portfolio-item col-sm-4 col-xs-6 margin-bottom-40">
                                <a href="#">
                                    <figure class="animate fadeInLeft">
                                        <img alt="image1" src="../images/Coming Soon.png">
                                        <figcaption>
                                            <h3>Coming Soon</h3>
                            ...
                            <li class="portfolio-item col-sm-4 col-xs-6 margin-bottom-40">
                                <a href="#">
                                    <figure class="animate fadeInRight">
                                        <img alt="image3" src="../images/Coming Soon.png">
                                        <figcaption>
                                            <h3>Belum Selesai</h3>
                                            <span>Bagian ini masih dalam konstruksi</span>
                                        </figcaption>
                            ...
                            <li class="portfolio-item col-sm-4 col-xs-6 margin-bottom-40">
                                <a href="#">
                                    <figure class="animate fadeIn">
                                        <img alt="image5" src="../images/Coming Soon.png">
                                        <figcaption>
                                            <h3>Dikelarin Dulu Ya~</h3>
                                            <span>Bagian ini masih dalam konstruksi</span>
                                        </figcaption>
                                    </figure>
                                </a>
                            ...
                            <li class="portfolio-item col-sm-4 col-xs-6 margin-bottom-40">
                                <a href="#">
                                    <figure class="animate fadeInRight">
                                        <img alt="image6" src="../images/Coming Soon.png">
                                        <figcaption>
                                            <h3>Mohon Bersabar</h3>
                                            <span>Bagian ini masih dalam konstruksi</span>
                                        </figcaption>
                                    </figure>
                                </a>
