...
abstract class BaseSfGuardPermissionPeer {
	...
	{
		include_once 'lib/model/map/SfGuardPermissionMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.SfGuardPermissionMapBuilder');
	}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/SfGuardGroupPermission.php';
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/SfGuardPermissionMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.SfGuardPermissionMapBuilder');
}
