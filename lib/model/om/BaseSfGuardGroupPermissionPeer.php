...
abstract class BaseSfGuardGroupPermissionPeer {
	...
	{
		include_once 'lib/model/map/SfGuardGroupPermissionMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.SfGuardGroupPermissionMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/SfGuardGroupPermissionMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.SfGuardGroupPermissionMapBuilder');
}
