...
abstract class BaseSfGuardRememberKeyPeer {
	...
	{
		include_once 'lib/model/map/SfGuardRememberKeyMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.SfGuardRememberKeyMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/SfGuardRememberKeyMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.SfGuardRememberKeyMapBuilder');
}
