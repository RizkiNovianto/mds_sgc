...
abstract class BaseSfGuardGroupPeer {
	...
	{
		include_once 'lib/model/map/SfGuardGroupMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.SfGuardGroupMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/SfGuardGroupMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.SfGuardGroupMapBuilder');
}
